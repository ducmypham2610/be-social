...
Let go of all your worries, and immerse yourself in a relaxing space from BeChill. <br/> Let's find friends with BeChill to share all your emotions with BeChill.</p>
                    ...
                    <div className="ChillBody">
                    <iframe style={{borderRadius:'15px'}} src="https://open.spotify.com/embed/playlist/7zl1RMR1wh6dEaNd4RxhnO?utm_source=generator" width="1200px" height="500px" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                    </div>
                </TabPanel>
            </div>
        </Layout>
